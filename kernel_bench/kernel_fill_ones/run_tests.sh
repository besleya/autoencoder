#!/bin/bash
#SBATCH --job-name=kbench_kernel_fill_ones
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_fill_ones/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_fill_ones/slurm_logs/%x_%j.err
