#!/bin/bash
#SBATCH --job-name=kbench_kernel_relu_backward
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_relu_backward/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_relu_backward/slurm_logs/%x_%j.err
