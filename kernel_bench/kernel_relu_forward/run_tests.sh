#!/bin/bash
#SBATCH --job-name=kbench_kernel_relu_forward
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_relu_forward/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_relu_forward/slurm_logs/%x_%j.err
...
cd /mnt/home/besleya/autoencoder/kernel_bench/kernel_relu_forward
