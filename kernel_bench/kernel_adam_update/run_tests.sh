#!/bin/bash
#SBATCH --job-name=kbench_kernel_adam_update
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_adam_update/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_adam_update/slurm_logs/%x_%j.err
...
cd /mnt/home/besleya/autoencoder/kernel_bench/kernel_adam_update
