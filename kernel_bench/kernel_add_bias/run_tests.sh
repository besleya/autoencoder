#!/bin/bash
#SBATCH --job-name=kbench_kernel_add_bias
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_add_bias/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_add_bias/slurm_logs/%x_%j.err
