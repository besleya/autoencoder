#!/bin/bash
#SBATCH --job-name=kbench_kernel_sparse_loss_and_grad
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_sparse_loss_and_grad/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_sparse_loss_and_grad/slurm_logs/%x_%j.err
