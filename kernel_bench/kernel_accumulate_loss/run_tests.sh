#!/bin/bash
#SBATCH --job-name=kbench_kernel_accumulate_loss
...
#SBATCH --output=/mnt/home/besleya/autoencoder/kernel_bench/kernel_accumulate_loss/slurm_logs/%x_%j.out
#SBATCH --error=/mnt/home/besleya/autoencoder/kernel_bench/kernel_accumulate_loss/slurm_logs/%x_%j.err
